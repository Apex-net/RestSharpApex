...
using System.Linq;
using System.Text;
using RestSharpApex.Authenticators.OAuth;
using RestSharpApex.Authenticators.OAuth.Extensions;

#if WINDOWS_PHONE
using System.Net;
#else
using RestSharpApex.Contrib;
#endif


namespace RestSharpApex.Authenticators
{
